...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  var window: UIWindow?
    ...
    func listenForFatalCoreDataNotifications() {
        ...
        let alert = UIAlertController(title: "Internal Error", message: "There was a fatal error in theapp and it cannot continue.\n\n" + "Press OK to terminate the app. Sorry for the inconvenience.", preferredStyle: .Alert)
  ...
  func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
    ...
    if let tabBarViewControllers = tabBarController.viewControllers
    {
        ...
        let currentLocationViewerController = tabBarViewControllers[0] as CurrentLocationViewController
        
        currentLocationViewerController.managedObjectContext = managedObjectContext
